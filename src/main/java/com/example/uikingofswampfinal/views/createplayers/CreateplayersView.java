...
import com.example.uikingofswampfinal.data.entity.SamplePerson;
import com.example.uikingofswampfinal.data.service.SamplePersonService;
...
public class CreateplayersView extends Div implements BeforeEnterObserver {
    ...
    public CreateplayersView(SamplePersonService samplePersonService) {
